...
const FAQPage: React.FunctionComponent = () => (
  <Layout title="FAQ">
    ...
    <p className={styles.answer}>Head over to the <CommonLink href="/user/new"
    >sign-up page</CommonLink> to see for yourself, and <CommonLink href="/contact"
    ...
    <p className={styles.answer}>Please <CommonLink href="/contact" >
