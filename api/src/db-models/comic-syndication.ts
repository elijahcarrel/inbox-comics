...
export type ComicFailureMode =
  ...
  | "FAR_SIDE_REJECTION" 
  | "FAR_SIDE_MISSING_IMAGE_ON_PAGE"
  | "FAR_SIDE_MISSING_CAPTION_ON_PAGE";
...
export const failureModes: { [key: string]: ComicFailureMode } = {
  ...
  THREE_WORD_PHRASE_MISSING_IMAGE_ON_PAGE:
    "THREE_WORD_PHRASE_MISSING_IMAGE_ON_PAGE",
  FAR_SIDE_REJECTION: "FAR_SIDE_REJECTION",
  FAR_SIDE_MISSING_IMAGE_ON_PAGE: "FAR_SIDE_MISSING_IMAGE_ON_PAGE",
  FAR_SIDE_MISSING_CAPTION_ON_PAGE: "FAR_SIDE_MISSING_CAPTION_ON_PAGE",
};
